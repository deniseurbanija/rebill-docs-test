...
const resources: Array<Resource> = [
  ...
  //   description:
  //     'Setup your SaaS Platform with multitenancy and automated payouts with ease.',
  ...
  // },
  // {
  //   name: 'Crossborder Pay Outs',
  //   href: '/products/pay-outs',
  //   description:
  //     'Disburse to one or more parties automatically or over API, in one or more countries.',
  ...
  // {
  //   name: 'Stripe Connect',
  //   href: '/products/stripe-connect',
  //   description:
  //     'Extend your coverage beyond Latin America by connecting with your Stripe Account.',
...
export function Products() {
  return (
    <div className="my-16 xl:max-w-none">
      <div className="not-prose grid grid-cols-1 gap-8 sm:grid-cols-2 xl:grid-cols-4 dark:border-white/5">
