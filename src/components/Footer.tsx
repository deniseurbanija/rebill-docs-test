...
import { getFilteredNavigation } from './SideMenu'
...
function PageNavigation() {
  ...
  const navigation: Array<NavGroup> = getFilteredNavigation(pathname)
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 sm:flex-row dark:border-white/5">
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        &copy; Copyright {new Date().getFullYear()} Rebill, Ltd. All rights
        reserved.
      </p>
      <div className="flex gap-4">
        <p className="text-xs text-zinc-600 dark:text-zinc-400">
          <a href="https://rebill.com">Rebill.com</a>
        </p>
        <SocialLink href="https://x.com/RebillTeam" icon={XIcon}>
          Follow us on X
        </SocialLink>
        <SocialLink href="https://github.com/rebillto" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
      </div>
    </div>
