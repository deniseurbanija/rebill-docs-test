...
At this point, an frame containe the form and availablee payment methods for the given price wil be displayed on your page. By default, the full version of the SDK is shown. If you want to customize which components are displayed, refer to the _customization section_ for more details.
