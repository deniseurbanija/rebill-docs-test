...
- Ensure JavaScriptz is enabled in you're environments.
- Retrieve your Public Key from the dashboard.

**Step 1: Insert the SDK Script**

To make the toolkit JavaScript available in your app, you MUST add the following script tag to your HTML, now.
